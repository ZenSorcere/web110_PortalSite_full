...
#EDIT THE FOLLOWING:
$toAddress = "michael.p.gilson@seattlecentral.edu";  //place your/your client's email address here
...
?>
	...
	<div>	
		<label>
			How Did You Hear About Mike?:<br />
			<select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
				<option value="">Choose How You Heard</option>
				<option value="Organization">Secret organiztion</option>
				<option value="Web">The Webs</option>
				<option value="Theater">Saw him in a show</option>
				<option value="A Friend">Mutual Friend</option>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Pirate Impressions" /> Pirate Impressions <br />
			<input type="checkbox" name="Interested_In[]" value="Superior Acting Skills" /> Superior Acting Skills <br />
			<input type="checkbox" name="Interested_In[]" value="Cupcakes" /> Delicious cupcakes <br />
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Mike loves comments!" tabindex="60"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
